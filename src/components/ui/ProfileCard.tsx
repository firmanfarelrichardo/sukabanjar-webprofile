...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, #0f172a 0%, #0086C955 100%)';
...
function ProfileCardComponent({
  ...
  miniAvatarUrl,
  name = 'Developer KKN UNILA',
  title = 'Fullstack Web Developer & Tim KKN 2026',
  handle = 'kkn.sukabanjar2026',
  status = 'UNILA 2026',
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        '--behind-glow-color': behindGlowColor ?? 'rgba(0, 134, 201, 0.7)',
